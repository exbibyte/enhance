...
TEST_CASE( "enAssetManager Double", "[ALL]" ) {
    SECTION( "Double single item" ){
	enAssetManager manager;
	bool bRet = manager.AddData( "Item_A", (double) 5 );
	bRet &= manager.AddData( "Item_B", (double) 23 );
	bRet &= manager.AddData( "Item_C", (double) -7 );
...
TEST_CASE( "enAssetManager Int", "[ALL]" ) {
