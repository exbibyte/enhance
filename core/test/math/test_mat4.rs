...
fn test_mat4(){
    ...
    {
        let v0 = Mat4 { _val: [ 1f64; 16 ], _is_row_major: true };
        let v1 = Mat4 { _val: [ 2f64,2f64,2f64,2f64,2f64,2f64,2f64,2f64,4f64,4f64,4f64,4f64,4f64,4f64,4f64,4f64 ], _is_row_major: true };
        let v2 = v0.mul(&v1).expect("mat mul invalid");
        let a = v2.is_equal( &Mat4{ _val: [ 12f64; 16 ], _is_row_major: true }, 0.0001f64 ).expect("mat mul invalid");
        assert!( a );
    }
    {
        //4x4 mul 4x1
