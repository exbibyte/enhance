...
dualquat scale_add_dualscalar( const dualscalar & s, const dualquat & q1, const dualquat & q2 ) {
    ...
    quat A = e2::math::quat::scale_add( a, q1._a, q2._a );
    quat B = e2::math::quat::scale_add( a, q1._b, q2._b );
...
dualquat scale_add_float( float s, const dualquat & q1, const dualquat & q2 ) {
    quat a = e2::math::quat::scale_add( s, q1._a, q2._a );
    quat b = e2::math::quat::scale_add( s, q1._b, q2._b );
    dualquat d( a, b );
    return d;
}
...
dualquat scale_dual_scalar(const dualscalar & s, const dualquat & q ) {
    ...
    quat A = e2::math::quat::scale( a, q._a );
    quat B = e2::math::quat::scale( a, q._b );
    quat B2 = e2::math::quat::scale( b, q._a );
    B = B + B2;
    dualquat d( A, B );
    return d;
}
...
dualquat scale_float( float s, const dualquat & q ) {
    quat A = e2::math::quat::scale( s, q._a );
    quat B = e2::math::quat::scale( s, q._b );
    dualquat d( A, B );
    return d;
}
