...
#define yyparse         yy_PolyMesh_parse
#define yylex           yy_PolyMesh_lex
#define yyerror         yy_PolyMesh_error
#define yydebug         yy_PolyMesh_debug
#define yynerrs         yy_PolyMesh_nerrs
...
{
       0,    56,    56,    59,    64,    68,    72,    78,    86,    91,
      98,   102,   110,   115,   119,   123,   129,   137,   143
};
#endif
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, struct ParseData_PolyMesh * pp)
{
