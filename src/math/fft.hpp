...
public:
    ...
    static void ifft_cooley_tukey( std::vector<std::complex<double> > & input, std::vector<double> & output );

    //helpers
    static std::vector<std::complex<double> > fft_cooley_tukey_radix_2_dit( std::vector<std::complex<double> > & input );
    static std::vector<std::complex<double> > ifft_cooley_tukey_radix_2_dit( std::vector<std::complex<double> > & input );
