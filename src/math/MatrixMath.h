...
namespace MatrixMath{
  ...
  bool InvertMatrix3x3(const float m[9], float invOut[9]);
  ...
  void Mat4x4Transpose(float const in[], float out[]);   /// transposes 4x4 matrix
  void Mat3x3Transpose(float const in[], float out[]);
