...
public class DualQuaternion {
    ...
    */
   public void dualQuaternionLinearBlending(double[] w, DualQuaternion[] q) {
   ...
   public void dualQuaternionIterativeBlending(double[] w, DualQuaternion[] q,
      double tol, int maxIters) {
      
      dualQuaternionLinearBlending(w, q); // initial state
   ...
   public void dualQuaternionIterativeBlending(double[] w, DualQuaternion[] q) {
      dualQuaternionIterativeBlending(
         w, q, DEFAULT_DIB_TOLERANCE, DEFAULT_DIB_MAX_ITERS);
   }
